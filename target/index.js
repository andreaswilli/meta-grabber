...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(/*! react */ \"react\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _tvShowInput = __webpack_require__(/*! ./components/tvShowInput */ \"./src/components/tvShowInput.js\");\n\nvar _tvShowInput2 = _interopRequireDefault(_tvShowInput);\n\nvar _filePicker = __webpack_require__(/*! ./components/filePicker */ \"./src/components/filePicker.js\");\n\nvar _filePicker2 = _interopRequireDefault(_filePicker);\n\nvar _request = __webpack_require__(/*! ./util/request */ \"./src/util/request.js\");\n\nvar _format = __webpack_require__(/*! ./util/format */ \"./src/util/format.js\");\n\nvar _fileRename = __webpack_require__(/*! ./components/fileRename */ \"./src/components/fileRename.js\");\n\nvar _fileRename2 = _interopRequireDefault(_fileRename);\n\nvar _button = __webpack_require__(/*! ./components/button */ \"./src/components/button.js\");\n\nvar _button2 = _interopRequireDefault(_button);\n\n__webpack_require__(/*! ./util/array.js */ \"./src/util/array.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar App = function (_Component) {\n  _inherits(App, _Component);\n\n  function App(props) {\n    _classCallCheck(this, App);\n\n    var _this = _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, props));\n\n    _this.get = (0, _request.makeRequestCreator)();\n\n    _this.initialState = {\n      files: [],\n      tvShow: null,\n      seasons: [],\n      query: '',\n      outputDir: null,\n      loading: false\n    };\n\n    _this.state = _this.initialState;\n    return _this;\n  }\n\n  _createClass(App, [{\n    key: 'chooseTvShow',\n    value: function chooseTvShow(tvShow) {\n      this.setState({ tvShow: tvShow.id });\n    }\n  }, {\n    key: 'getSeasonsOf',\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tvShow) {\n        var _this2 = this;\n\n        var response, seasons;\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                if (!(!tvShow || !tvShow.id)) {\n                  _context2.next = 3;\n                  break;\n                }\n\n                this.setState({ seasons: [] });\n                return _context2.abrupt('return');\n\n              case 3:\n                this.setState({ loading: true });\n                _context2.prev = 4;\n                _context2.next = 7;\n                return this.get(_request.baseUrl + '/tv/' + tvShow.id + '?api_key=' + _request.apiKey + '&language=de');\n\n              case 7:\n                response = _context2.sent;\n                _context2.next = 10;\n                return Promise.all(response.data.seasons.map(function () {\n                  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(season) {\n                    var _response;\n\n                    return regeneratorRuntime.wrap(function _callee$(_context) {\n                      while (1) {\n                        switch (_context.prev = _context.next) {\n                          case 0:\n                            _context.prev = 0;\n                            _context.next = 3;\n                            return (0, _request.makeRequestCreator)()(_request.baseUrl + '/tv/' + tvShow.id + '/season/' + season.season_number + '?api_key=' + _request.apiKey + '&language=de');\n\n                          case 3:\n                            _response = _context.sent;\n                            return _context.abrupt('return', _response.data);\n\n                          case 7:\n                            _context.prev = 7;\n                            _context.t0 = _context['catch'](0);\n\n                          case 9:\n                          case 'end':\n                            return _context.stop();\n                        }\n                      }\n                    }, _callee, _this2, [[0, 7]]);\n                  }));\n\n                  return function (_x2) {\n                    return _ref2.apply(this, arguments);\n                  };\n                }()\n                // TODO: error handling\n                ));\n\n              case 10:\n                seasons = _context2.sent;\n\n                this.setState({ seasons: seasons, loading: false });\n                _context2.next = 18;\n                break;\n\n              case 14:\n                _context2.prev = 14;\n                _context2.t0 = _context2['catch'](4);\n\n                if (_axios2.default.isCancel(_context2.t0)) {\n                  // ignore canceled request\n                } else {\n                    // TODO: error handling\n                  };\n\n              case 18:\n              case 'end':\n                return _context2.stop();\n            }\n          }\n        }, _callee2, this, [[4, 14]]);\n      }));\n\n      function getSeasonsOf(_x) {\n        return _ref.apply(this, arguments);\n      }\n\n      return getSeasonsOf;\n    }()\n  }, {\n    key: 'handleSelect',\n    value: function handleSelect(tvShow) {\n      this.chooseTvShow(tvShow);\n      this.getSeasonsOf(tvShow);\n    }\n\n    // use Set() to prevent duplicates in array\n\n  }, {\n    key: 'handleFileOpen',\n    value: function handleFileOpen(files) {\n      this.setState({\n        files: files.length === 0 ? files : [].concat(_toConsumableArray(new Set([].concat(_toConsumableArray(this.state.files), _toConsumableArray(files)))))\n      });\n    }\n  }, {\n    key: 'handleFileRenameSuccess',\n    value: function handleFileRenameSuccess() {\n      this.setState(this.initialState);\n    }\n  }, {\n    key: 'render',\n    value: function render() {\n      var _this3 = this;\n\n      return _react2.default.createElement(\n        'div',\n        { className: 'container' },\n        _react2.default.createElement(\n          'div',\n          { className: 'page' },\n          _react2.default.createElement(\n            'div',\n            { className: 'section' },\n            _react2.default.createElement(_tvShowInput2.default, {\n              query: this.state.query,\n              onSelect: this.handleSelect.bind(this),\n              onChange: function onChange(query) {\n                return _this3.setState({ query: query });\n              }\n            }),\n            _react2.default.createElement(_filePicker2.default, { onFileOpen: this.handleFileOpen.bind(this) }),\n            _react2.default.createElement(_button2.default, {\n              label: 'settings',\n              className: 'settings-button',\n              onClick: function onClick() {}\n            })\n          ),\n          _react2.default.createElement(_fileRename2.default, {\n            seasons: this.state.seasons.map(function (s) {\n              return {\n                name: s.name,\n                episodes: s.episodes.map(function (e) {\n                  return (0, _format.formatEpisodeName)(e, _this3.state.tvShow);\n                })\n              };\n            }),\n            loading: this.state.loading,\n            files: this.state.files.sort(),\n            outputDir: this.state.outputDir,\n            onFileRenameSuccess: this.handleFileRenameSuccess.bind(this),\n            onChooseOutputDir: function onChooseOutputDir(outputDir) {\n              return _this3.setState({ outputDir: outputDir });\n            },\n            onClearOutputDir: function onClearOutputDir() {\n              return _this3.setState({ outputDir: null });\n            }\n          })\n        )\n      );\n    }\n  }]);\n\n  return App;\n}(_react.Component);\n\nexports.default = App;\n\n//# sourceURL=webpack:///./src/app.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(/*! react */ \"react\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _fs = __webpack_require__(/*! fs */ \"fs\");\n\nvar _fs2 = _interopRequireDefault(_fs);\n\nvar _electron = __webpack_require__(/*! electron */ \"electron\");\n\nvar _classnames = __webpack_require__(/*! classnames */ \"./node_modules/classnames/index.js\");\n\nvar _classnames2 = _interopRequireDefault(_classnames);\n\nvar _reactAnimateHeight = __webpack_require__(/*! react-animate-height */ \"./node_modules/react-animate-height/lib/AnimateHeight.js\");\n\nvar _reactAnimateHeight2 = _interopRequireDefault(_reactAnimateHeight);\n\nvar _button = __webpack_require__(/*! ./button */ \"./src/components/button.js\");\n\nvar _button2 = _interopRequireDefault(_button);\n\nvar _array = __webpack_require__(/*! ../util/array */ \"./src/util/array.js\");\n\nvar _format = __webpack_require__(/*! ../util/format */ \"./src/util/format.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar FileRename = function (_Component) {\n  _inherits(FileRename, _Component);\n\n  function FileRename(props) {\n    _classCallCheck(this, FileRename);\n\n    var _this = _possibleConstructorReturn(this, (FileRename.__proto__ || Object.getPrototypeOf(FileRename)).call(this, props));\n\n    _this.state = {\n      excludedSeasons: [],\n      assignments: []\n    };\n    return _this;\n  }\n\n  _createClass(FileRename, [{\n    key: 'componentWillReceiveProps',\n    value: function componentWillReceiveProps(nextProps) {\n      if (JSON.stringify(this.props.seasons) !== JSON.stringify(nextProps.seasons)) {\n        this.setState({ excludedSeasons: [] });\n      }\n      this.assignEpisodesToFiles(nextProps);\n    }\n  }, {\n    key: 'isSeasonExcluded',\n    value: function isSeasonExcluded(seasonName) {\n      return this.state.excludedSeasons.find(function (season) {\n        return season.name === seasonName;\n      }) !== undefined;\n    }\n  }, {\n    key: 'isEpisodeExcluded',\n    value: function isEpisodeExcluded(episodeName) {\n      return this.state.excludedSeasons.filter(function (season) {\n        return season.excludedEpisodes.filter(function (episode) {\n          return episode === episodeName;\n        }).length > 0;\n      }).length > 0;\n    }\n  }, {\n    key: 'isWholeSeasonExcluded',\n    value: function isWholeSeasonExcluded(seasonName) {\n      return (this.state.excludedSeasons.find(function (season) {\n        return season.name === seasonName;\n      }) || { excludedEpisodes: {} }).excludedEpisodes.length === this.props.seasons.find(function (season) {\n        return season.name === seasonName;\n      }).episodes.length;\n    }\n  }, {\n    key: 'handleSeasonChange',\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e, seasonName) {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                if (!e.target.checked) {\n                  _context.next = 5;\n                  break;\n                }\n\n                _context.next = 3;\n                return this.setState({\n                  excludedSeasons: this.state.excludedSeasons.filter(function (s) {\n                    return s.name !== seasonName;\n                  })\n                });\n\n              case 3:\n                _context.next = 7;\n                break;\n\n              case 5:\n                _context.next = 7;\n                return this.setState({\n                  excludedSeasons: [].concat(_toConsumableArray(this.state.excludedSeasons), [{\n                    name: seasonName,\n                    excludedEpisodes: this.props.seasons.find(function (s) {\n                      return s.name === seasonName;\n                    }).episodes\n                  }])\n                });\n\n              case 7:\n                this.assignEpisodesToFiles(this.props);\n\n              case 8:\n              case 'end':\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function handleSeasonChange(_x, _x2) {\n        return _ref.apply(this, arguments);\n      }\n\n      return handleSeasonChange;\n    }()\n  }, {\n    key: 'handleEpisodeChange',\n    value: function () {\n      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e, episodeName) {\n        var season, excludedSeason, excludedEpisodes, excludedSeasons, _excludedSeasons;\n\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                season = this.props.seasons.find(function (season) {\n                  return season.episodes.filter(function (episode) {\n                    return episode === episodeName;\n                  }).length > 0;\n                });\n                excludedSeason = this.state.excludedSeasons.find(function (s) {\n                  return s.name === season.name;\n                });\n\n                if (!e.target.checked) {\n                  _context2.next = 10;\n                  break;\n                }\n\n                // include episode\n                excludedEpisodes = excludedSeason.excludedEpisodes.filter(function (e) {\n                  return e !== episodeName;\n                });\n                excludedSeasons = this.state.excludedSeasons.filter(function (s) {\n                  return s.name !== excludedSeason.name;\n                });\n\n                if (excludedEpisodes.length > 0) {\n                  excludedSeasons = [].concat(_toConsumableArray(excludedSeasons), [{\n                    name: excludedSeason.name,\n                    excludedEpisodes: excludedEpisodes\n                  }]);\n                }\n                _context2.next = 8;\n                return this.setState({ excludedSeasons: excludedSeasons });\n\n              case 8:\n                _context2.next = 13;\n                break;\n\n              case 10:\n                // exclude episode\n                _excludedSeasons = excludedSeason ? [].concat(_toConsumableArray(this.state.excludedSeasons.filter(function (s) {\n                  return s.name !== excludedSeason.name;\n                })), [{\n                  name: excludedSeason.name,\n                  excludedEpisodes: [].concat(_toConsumableArray(excludedSeason.excludedEpisodes), [episodeName])\n                }]) : [].concat(_toConsumableArray(this.state.excludedSeasons), [{\n                  name: season.name,\n                  excludedEpisodes: [episodeName]\n                }]);\n                _context2.next = 13;\n                return this.setState({ excludedSeasons: _excludedSeasons });\n\n              case 13:\n                this.assignEpisodesToFiles(this.props);\n\n              case 14:\n              case 'end':\n                return _context2.stop();\n            }\n          }\n        }, _callee2, this);\n      }));\n\n      function handleEpisodeChange(_x3, _x4) {\n        return _ref2.apply(this, arguments);\n      }\n\n      return handleEpisodeChange;\n    }()\n  }, {\n    key: 'assignEpisodesToFiles',\n    value: function assignEpisodesToFiles(props) {\n      var _this2 = this;\n\n      var excludedEpisodesCount = 0;\n      this.setState({\n        assignments: (0, _array.flatten)(props.seasons.map(function (s) {\n          return s.episodes;\n        })).map(function (e, i) {\n          var excluded = _this2.isEpisodeExcluded(e);\n          if (excluded) {\n            excludedEpisodesCount++;\n          }\n          return {\n            name: e,\n            fileName: excluded ? undefined : props.files[i - excludedEpisodesCount]\n          };\n        })\n      });\n    }\n  }, {\n    key: 'getAssignedFileName',\n    value: function getAssignedFileName(episodeName) {\n      var assignment = this.state.assignments.find(function (a) {\n        return a.name === episodeName;\n      });\n      return assignment ? assignment.fileName : null;\n    }\n  }, {\n    key: 'handleChooseOutputDir',\n    value: function () {\n      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {\n        var outputDir;\n        return regeneratorRuntime.wrap(function _callee3$(_context3) {\n          while (1) {\n            switch (_context3.prev = _context3.next) {\n              case 0:\n                _context3.next = 2;\n                return _electron.remote.dialog.showOpenDialog({\n                  properties: ['openDirectory', 'createDirectory']\n                });\n\n              case 2:\n                outputDir = _context3.sent;\n\n                if (outputDir) {\n                  _context3.next = 5;\n                  break;\n                }\n\n                return _context3.abrupt('return');\n\n              case 5:\n                this.props.onChooseOutputDir(outputDir);\n\n              case 6:\n              case 'end':\n                return _context3.stop();\n            }\n          }\n        }, _callee3, this);\n      }));\n\n      function handleChooseOutputDir() {\n        return _ref3.apply(this, arguments);\n      }\n\n      return handleChooseOutputDir;\n    }()\n  }, {\n    key: 'renameFiles',\n    value: function renameFiles() {\n      var _this3 = this;\n\n      var error = false;\n      var assignments = this.state.assignments.filter(function (a) {\n        return a.fileName;\n      });\n      assignments.map(function (a, i) {\n        var newFileName = (_this3.props.outputDir || (0, _format.formatFilePath)(a.fileName)) + '/' + a.name + '.' + (0, _format.formatFileExtension)(a.fileName);\n        _fs2.default.rename(a.fileName, newFileName, function (err) {\n          if (err) {\n            error = true;\n            throw err;\n          }\n          if (i >= assignments.length - 1 && !error) {\n            _this3.props.onFileRenameSuccess();\n          }\n        });\n      });\n    }\n  }, {\n    key: 'render',\n    value: function render() {\n      var _this4 = this;\n\n      return _react2.default.createElement(\n        _react2.default.Fragment,\n        null,\n        _react2.default.createElement(\n          'div',\n          { className: 'section section--main' },\n          _react2.default.createElement(\n            'div',\n            { className: 'file-rename__seasons' },\n            this.props.loading && _react2.default.createElement(\n              'div',\n              { className: 'file-rename__loading' },\n              'loading...'\n            ),\n            !this.props.loading && (this.props.seasons || []).map(function (s, i) {\n              return _react2.default.createElement(\n                _reactAnimateHeight2.default,\n                {\n                  key: s.name,\n                  duration: 500,\n                  height: _this4.isWholeSeasonExcluded(s.name) ? 62 : 'auto'\n                },\n                _react2.default.createElement(\n                  'label',\n                  { className: (0, _classnames2.default)('file-rename__item', {\n                      'file-rename__item--season--excluded': _this4.isWholeSeasonExcluded(s.name)\n                    }) },\n                  _react2.default.createElement('input', {\n                    type: 'checkbox',\n                    className: 'file-rename__item__checkbox',\n                    checked: !_this4.isSeasonExcluded(s.name),\n                    onChange: function onChange(event) {\n                      return _this4.handleSeasonChange(event, s.name);\n                    }\n                  }),\n                  s.name\n                ),\n                s.episodes.map(function (e, i) {\n                  return _react2.default.createElement(\n                    'div',\n                    { key: e },\n                    _react2.default.createElement(\n                      'label',\n                      { className: (0, _classnames2.default)('file-rename__item', 'file-rename__item--episode', {\n                          'file-rename__item--even': i % 2 == 0,\n                          'file-rename__item--included': !_this4.isEpisodeExcluded(e)\n                        }) },\n                      _react2.default.createElement('input', {\n                        type: 'checkbox',\n                        className: 'file-rename__item__checkbox',\n                        checked: !_this4.isEpisodeExcluded(e),\n                        onChange: function onChange(event) {\n                          return _this4.handleEpisodeChange(event, e);\n                        }\n                      }),\n                      _react2.default.createElement(\n                        'div',\n                        null,\n                        e\n                      ),\n                      _react2.default.createElement(\n                        'div',\n                        { className: 'file-rename__item__file-name' },\n                        (0, _format.formatFileName)(_this4.getAssignedFileName(e))\n                      )\n                    )\n                  );\n                })\n              );\n            })\n          )\n        ),\n        _react2.default.createElement(\n          'div',\n          { className: 'section section--output' },\n          _react2.default.createElement(\n            'div',\n            { className: 'file-rename__output__dir' },\n            this.props.outputDir || 'none (leave the files where they are)'\n          ),\n          _react2.default.createElement(_button2.default, {\n            className: 'file-rename__output__choose',\n            label: 'choose output dir',\n            onClick: this.handleChooseOutputDir.bind(this)\n          }),\n          _react2.default.createElement(_button2.default, {\n            className: 'file-rename__output__clear',\n            label: 'X',\n            onClick: this.props.onClearOutputDir\n          }),\n          _react2.default.createElement(_button2.default, {\n            className: 'file-rename__rename-button',\n            label: 'rename',\n            onClick: this.renameFiles.bind(this)\n          })\n        )\n      );\n    }\n  }]);\n\n  return FileRename;\n}(_react.Component);\n\nexports.default = FileRename;\n\n//# sourceURL=webpack:///./src/components/fileRename.js?");

/***/ }),

/***/ "./src/components/tvShowInput.js":
/*!***************************************!*\
  !*** ./src/components/tvShowInput.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.flatten = flatten;\nfunction flatten(array) {\n    return array.reduce(function (acc, val) {\n        return acc.concat(val);\n    }, []);\n}\n\nif (!Array.prototype.last) {\n    Array.prototype.last = function () {\n        return this[this.length - 1];\n    };\n};\n\n//# sourceURL=webpack:///./src/util/array.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.formatFileName = formatFileName;\nexports.formatFilePath = formatFilePath;\nexports.formatFileExtension = formatFileExtension;\nexports.formatEpisodeName = formatEpisodeName;\nvar template = 'S{season_number} E{episode_number} - {episode_name}';\n\nfunction formatFileName(fileName) {\n  if (!fileName) return fileName;\n  return fileName.split('/').last();\n}\n\nfunction formatFilePath(fileName) {\n  if (!fileName) return fileName;\n  return fileName.split('/').slice(0, -1).join('/');\n}\n\nfunction formatFileExtension(fileName) {\n  if (!fileName) return fileName;\n  return fileName.split('.').last();\n}\n\nfunction formatEpisodeName(episode, tvShow) {\n  return template.replace(/\\{tvshow_name\\}/g, tvShow.name).replace(/\\{season_number\\}/g, leftPad(episode.season_number, 2, 0)).replace(/\\{episode_number\\}/g, leftPad(episode.episode_number, 2, 0)).replace(/\\{episode_name\\}/g, episode.name.replace(/[#%&\\{\\}\\\\<>\\*\\?/$!'\":@]/g, ''));\n}\n\nfunction leftPad(string, length, char) {\n  string = string + '';\n  length = length - string.length;\n  if (length < 0) {\n    return string;\n  }\n  if (!char && char !== 0) {\n    char = ' ';\n  }\n  char = char + '';\n  return char.repeat(length) + string;\n}\n\n//# sourceURL=webpack:///./src/util/format.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.apiKey = exports.baseUrl = undefined;\nexports.makeRequestCreator = makeRequestCreator;\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar baseUrl = exports.baseUrl = 'http://api.themoviedb.org/3';\n\nvar apiKey = exports.apiKey = 'a7493504f75921f0d0f10f96d468d6cd';\n\nfunction makeRequestCreator() {\n  var call;\n  return function (url) {\n    if (call) {\n      call.cancel();\n    }\n    call = _axios2.default.CancelToken.source();\n    return _axios2.default.get(url, { cancelToken: call.token });\n  };\n}\n\n//# sourceURL=webpack:///./src/util/request.js?");
